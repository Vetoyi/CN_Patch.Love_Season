...
3. 根据作者目前更新情况来看，每次推出新游戏版本应该都会影响本补丁正常使用，到时如果我长期没有更新补丁跟进，请根据[目录“(必读)如何使用补丁](https://github.com/Vetoyi/CN_Patch.Love_Season#warning重要bangbang如果未来游戏出了新版本但我长期没有更新补丁跟进请根据以下步骤先删除部分补丁文件再安装汉化补丁至游戏否则游戏或将存在报错严重则可能导致你的存档无法兼容游戏原版补丁后续版本得不偿失请勿不当回事如为先前已使用过本汉化请先检测游戏完整性再继续下列步骤)删除部分补丁文件，以继续正常使用本汉化补丁；该操作会导致游戏画廊的汉化失效。
