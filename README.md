...
<br>汉化文件取自杰尼龟汉化组，经由我再次修改以适配Steam版，同时或也会对汉化进行不定程度的修改或补完，以在补丁后续版本逐步完善汉化(鸽)。
<br><br><br>
...
3. 根据作者目前更新情况来看，每次推出新游戏版本应该都会影响本补丁正常使用，到时如果我长期没有更新补丁跟进，请根据[目录“(必读)如何使用补丁](https://github.com/Vetoyi/CN_Patch.Love_Season#o必读bangbang如何使用补丁)删除部分补丁文件，以继续正常使用本汉化补丁；该操作会导致游戏画廊的汉化失效。
